...
void FractalTypeWidget::on_spinB1_valueChanged()
{
    saveData();
}
...
void FractalTypeWidget::saveData()
{
	...
	//m_type.setb1(m_ui.spinB1 -> value());
...
void FractalTypeWidget::on_radioReal_toggled(bool checked)
{
    m_ui.spind1->setEnabled(true);
    m_ui.spind2->setEnabled(true);
}

void FractalTypeWidget::on_radioIntegral_toggled(bool checked)
{
    m_ui.spind1->setEnabled(false);
    m_ui.spind2->setEnabled(false);
}

void FractalTypeWidget::on_spind1_valueChanged(double arg1)
{
    parameter003=arg1;
}

void FractalTypeWidget::on_spind2_valueChanged(double arg1)
{
    parameter004=arg1;
}
