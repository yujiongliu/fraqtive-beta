...
private slots:
    ...
    void on_spinB1_valueChanged();

    void on_radioReal_toggled(bool checked);

    void on_spind1_valueChanged(double arg1);

    void on_spind2_valueChanged(double arg1);

    void on_radioIntegral_toggled(bool checked);
