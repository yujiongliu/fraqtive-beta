...
void ParametersPage::on_SliderT_valueChanged(int value)
{
    double t=value/10000.0;
    parameter001=t;
    m_ui.label_5->setText(QString::number(t));
    m_model->navigateBackward();
    m_model->navigateForward();
}

void ParametersPage::on_lineEdit_2_textChanged(const QString &arg1)
{
    //QString t_text=m_ui.lineEdit_2->text();
    double t = arg1.toDouble();
    parameter001=t;
    m_ui.SliderT->setValue((int)(t*10000));
    m_model->navigateBackward();
    m_model->navigateForward();
}

void ParametersPage::on_lineEdit_textChanged(const QString &arg1)
{
    parameter002=arg1.toInt();
    m_model->navigateBackward();
    m_model->navigateForward();
}
