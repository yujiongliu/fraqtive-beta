...
static const char qt_meta_stringdata_GradientDialog[] = {
    "GradientDialog\0\0gradient\0"
    "applyGradient(Gradient)\0"
    "on_gradient_gradientChanged()\0button\0"
...
void GradientDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->applyGradient((*reinterpret_cast< const Gradient(*)>(_a[1]))); break;
        case 1: _t->on_gradient_gradientChanged(); break;
...
const QMetaObjectExtraData GradientDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GradientDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_GradientDialog,
      qt_meta_data_GradientDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GradientDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GradientDialog))
...
// SIGNAL 0
void GradientDialog::applyGradient(const Gradient & _t1)
{
