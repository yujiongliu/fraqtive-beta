...
void ViewContainer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData ViewContainer::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ViewContainer::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ViewContainer,
      qt_meta_data_ViewContainer, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ViewContainer::getStaticMetaObject() { return staticMetaObject; }
