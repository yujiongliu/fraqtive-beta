/********************************************************************************
** Form generated from reading UI file 'loadbookmarkdialog.ui'
**
...
#ifndef UI_LOADBOOKMARKDIALOG_H
#define UI_LOADBOOKMARKDIALOG_H
...
public:
    ...
    void setupUi(QDialog *LoadBookmarkDialog)
    {
        if (LoadBookmarkDialog->objectName().isEmpty())
            LoadBookmarkDialog->setObjectName(QString::fromUtf8("LoadBookmarkDialog"));
        LoadBookmarkDialog->resize(650, 380);
        topLayout = new QVBoxLayout(LoadBookmarkDialog);
        topLayout->setSpacing(0);
        topLayout->setContentsMargins(0, 0, 0, 0);
        topLayout->setObjectName(QString::fromUtf8("topLayout"));
        promptWidget = new XmlUi::GradientWidget(LoadBookmarkDialog);
        ...
        line = new QFrame(LoadBookmarkDialog);
        ...
        mainWidget = new QWidget(LoadBookmarkDialog);
        ...
        retranslateUi(LoadBookmarkDialog);
        QObject::connect(buttonBox, SIGNAL(accepted()), LoadBookmarkDialog, SLOT(accept()));
        QObject::connect(buttonBox, SIGNAL(rejected()), LoadBookmarkDialog, SLOT(reject()));

        QMetaObject::connectSlotsByName(LoadBookmarkDialog);
    } // setupUi

    void retranslateUi(QDialog *LoadBookmarkDialog)
    {
        LoadBookmarkDialog->setWindowTitle(QApplication::translate("LoadBookmarkDialog", "Load Bookmark", 0, QApplication::UnicodeUTF8));
        groupPreview->setTitle(QApplication::translate("LoadBookmarkDialog", "Preview", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class LoadBookmarkDialog: public Ui_LoadBookmarkDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_LOADBOOKMARKDIALOG_H
